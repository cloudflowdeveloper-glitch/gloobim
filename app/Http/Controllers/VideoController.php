...
class VideoController extends Controller
{
    public function index(): Response
    {
        ...
        if (empty($videos)) {
            $videos = [
                ['id' => 1, 'user_id' => 1, 'title' => 'The Future of Artificial Intelligence in 2025', 'description' => 'An in-depth look at how AI is transforming the world and what comes next.', 'thumbnail' => 'https://placehold.co/640x360/4f46e5/ffffff?text=AI+Future', 'video_url' => '', 'duration' => 1965, 'views' => 124000, 'likes' => 8200, 'comments_count' => 340, 'shares' => 1200, 'category' => 'tech', 'status' => 'published', 'creator_name' => 'Tech with Arjun', 'username' => 'techarjun', 'creator_avatar' => 'https://placehold.co/80/80/6d28d9/ffffff?text=TA', 'is_verified' => 1, 'created_at' => date('Y-m-d H:i:s', strtotime('-2 days'))],
                ['id' => 2, 'user_id' => 2, 'title' => 'Exploring Mars: A New Frontier', 'description' => 'NASA\'s latest discoveries on the red planet.', 'thumbnail' => 'https://placehold.co/640x360/ea580c/ffffff?text=Mars', 'video_url' => '', 'duration' => 1696, 'views' => 89000, 'likes' => 6500, 'comments_count' => 210, 'shares' => 890, 'category' => 'tech', 'status' => 'published', 'creator_name' => 'Space Insight', 'username' => 'spaceinsight', 'creator_avatar' => 'https://placehold.co/80/80/2563eb/ffffff?text=SI', 'is_verified' => 1, 'created_at' => date('Y-m-d H:i:s', strtotime('-5 days'))],
                ['id' => 3, 'user_id' => 3, 'title' => 'How I Edit My YouTube Videos (Full Process)', 'description' => 'Complete video editing workflow from start to finish.', 'thumbnail' => 'https://placehold.co/640x360/9333ea/ffffff?text=Editing', 'video_url' => '', 'duration' => 1290, 'views' => 67000, 'likes' => 5100, 'comments_count' => 180, 'shares' => 670, 'category' => 'tech', 'status' => 'published', 'creator_name' => 'Creator Flow', 'username' => 'creatorflow', 'creator_avatar' => 'https://placehold.co/80/80/ec4899/ffffff?text=CF', 'is_verified' => 1, 'created_at' => date('Y-m-d H:i:s', strtotime('-3 days'))],
                ['id' => 4, 'user_id' => 4, 'title' => 'I Spent 30 Days Alone in the Wild', 'description' => 'Surviving 30 days in the wilderness with nothing but a knife.', 'thumbnail' => 'https://placehold.co/640x360/16a34a/ffffff?text=Wild', 'video_url' => '', 'duration' => 1122, 'views' => 245000, 'likes' => 18000, 'comments_count' => 2400, 'shares' => 3400, 'category' => 'education', 'status' => 'published', 'creator_name' => 'WanderLens', 'username' => 'wanderlens', 'creator_avatar' => 'https://placehold.co/80/80/22c55e/ffffff?text=WL', 'is_verified' => 1, 'created_at' => date('Y-m-d H:i:s', strtotime('-1 day'))],
                ['id' => 5, 'user_id' => 5, 'title' => 'Top 10 Fastest Cars in the World 2025', 'description' => 'The ultimate countdown of speed machines.', 'thumbnail' => 'https://placehold.co/640x360/6b21a8/ffffff?text=Supercars', 'video_url' => '', 'duration' => 862, 'views' => 98000, 'likes' => 7200, 'comments_count' => 450, 'shares' => 1100, 'category' => 'tech', 'status' => 'published', 'creator_name' => 'Auto Gear', 'username' => 'autogear', 'creator_avatar' => 'https://placehold.co/80/80/f59e0b/ffffff?text=AG', 'is_verified' => 1, 'created_at' => date('Y-m-d H:i:s', strtotime('-1 day'))],
                ['id' => 6, 'user_id' => 6, 'title' => 'Making a Hit Song in 24 Hours Challenge', 'description' => 'Can we produce a hit track in just 24 hours?', 'thumbnail' => 'https://placehold.co/640x360/e82c3d/ffffff?text=Music', 'video_url' => '', 'duration' => 517, 'views' => 76000, 'likes' => 5800, 'comments_count' => 320, 'shares' => 950, 'category' => 'music', 'status' => 'published', 'creator_name' => 'BeatMaster', 'username' => 'beatmaster', 'creator_avatar' => 'https://placehold.co/80/80/e82c3d/ffffff?text=BM', 'is_verified' => 1, 'created_at' => date('Y-m-d H:i:s', strtotime('-2 days'))],
                ['id' => 7, 'user_id' => 7, 'title' => 'Paradise Found: Top 5 Islands to Visit', 'description' => 'The most beautiful islands you must see.', 'thumbnail' => 'https://placehold.co/640x360/0891b2/ffffff?text=Islands', 'video_url' => '', 'duration' => 1005, 'views' => 64000, 'likes' => 4900, 'comments_count' => 280, 'shares' => 780, 'category' => 'education', 'status' => 'published', 'creator_name' => 'Travel Diaries', 'username' => 'travel', 'creator_avatar' => 'https://placehold.co/80/80/0891b2/ffffff?text=TD', 'is_verified' => 1, 'created_at' => date('Y-m-d H:i:s', strtotime('-3 days'))],
                ['id' => 8, 'user_id' => 8, 'title' => 'My New Camera Setup for 2025!', 'description' => 'Here\'s my new camera setup and why I chose each gear.', 'thumbnail' => 'https://placehold.co/640x360/f59e0b/ffffff?text=Camera', 'video_url' => '', 'duration' => 1164, 'views' => 12000, 'likes' => 980, 'comments_count' => 65, 'shares' => 120, 'category' => 'tech', 'status' => 'published', 'creator_name' => 'Shutter Stories', 'username' => 'shutter', 'creator_avatar' => 'https://placehold.co/80/80/f59e0b/ffffff?text=SS', 'is_verified' => 1, 'created_at' => date('Y-m-d H:i:s', strtotime('-6 hours'))],
                ['id' => 9, 'user_id' => 9, 'title' => 'Investing for Beginners (Complete Guide)', 'description' => 'Everything you need to know about investing.', 'thumbnail' => 'https://placehold.co/640x360/16a34a/ffffff?text=Invest', 'video_url' => '', 'duration' => 912, 'views' => 8700, 'likes' => 640, 'comments_count' => 42, 'shares' => 85, 'category' => 'business', 'status' => 'published', 'creator_name' => 'Finance Mindset', 'username' => 'finance', 'creator_avatar' => 'https://placehold.co/80/80/16a34a/ffffff?text=FM', 'is_verified' => 0, 'created_at' => date('Y-m-d H:i:s', strtotime('-8 hours'))],
            ];
        }
        ...
        $creatorsToWatch = [
            ['id' => 1, 'name' => 'Tech with Arjun', 'avatar' => 'https://placehold.co/80/80/6d28d9/ffffff?text=TA', 'is_verified' => 1, 'subscriber_count' => 428000, 'follower_count' => 428000, 'is_following' => $myId > 0 && $this->isFollowing($myId, 1)],
            ['id' => 2, 'name' => "Sara's Studio", 'avatar' => 'https://placehold.co/80/80/ec4899/ffffff?text=SS', 'is_verified' => 1, 'subscriber_count' => 312000, 'follower_count' => 312000, 'is_following' => $myId > 0 && $this->isFollowing($myId, 2)],
            ['id' => 3, 'name' => 'GameOn', 'avatar' => 'https://placehold.co/80/80/f59e0b/ffffff?text=GO', 'is_verified' => 1, 'subscriber_count' => 289000, 'follower_count' => 289000, 'is_following' => $myId > 0 && $this->isFollowing($myId, 3)],
        ];
