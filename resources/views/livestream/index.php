...
if (empty($liveStreams)) {
    $liveStreams = [
        ['id' => 1, 'title' => 'Late Night Music Session', 'description' => 'Live music and chat', 'thumbnail' => '/uploads/profiles/admin.jpg', 'user_id' => 2, 'creator_name' => 'Zara Ke', 'username' => 'zarake', 'creator_avatar' => '/uploads/profiles/admin.jpg', 'is_verified' => 1, 'viewers' => 4200, 'peak_viewers' => 8500, 'total_likes' => 234, 'total_gifts' => 56, 'gift_earnings' => 4250, 'category' => 'Music', 'started_at' => date('Y-m-d H:i:s'), 'status' => 'live'],
        ['id' => 2, 'title' => 'Q&A: Starting Your Journey', 'description' => 'Ask me anything', 'thumbnail' => '/uploads/profiles/admin.jpg', 'user_id' => 2, 'creator_name' => 'Zara Ke', 'username' => 'zarake', 'creator_avatar' => '/uploads/profiles/admin.jpg', 'is_verified' => 1, 'viewers' => 2800, 'peak_viewers' => 5100, 'total_likes' => 89, 'total_gifts' => 23, 'gift_earnings' => 1820, 'category' => 'Lifestyle', 'started_at' => date('Y-m-d H:i:s'), 'status' => 'live'],
        ['id' => 3, 'title' => 'Cooking with Zara', 'description' => 'Recipe time!', 'thumbnail' => '/uploads/profiles/admin.jpg', 'user_id' => 2, 'creator_name' => 'Zara Ke', 'username' => 'zarake', 'creator_avatar' => '/uploads/profiles/admin.jpg', 'is_verified' => 1, 'viewers' => 1200, 'peak_viewers' => 3200, 'total_likes' => 156, 'total_gifts' => 34, 'gift_earnings' => 2100, 'category' => 'Food', 'started_at' => date('Y-m-d H:i:s'), 'status' => 'live'],
        ['id' => 4, 'title' => 'Gaming Marathon', 'description' => '24hr gaming challenge', 'thumbnail' => '/uploads/profiles/admin.jpg', 'user_id' => 2, 'creator_name' => 'Zara Ke', 'username' => 'zarake', 'creator_avatar' => '/uploads/profiles/admin.jpg', 'is_verified' => 1, 'viewers' => 8900, 'peak_viewers' => 12400, 'total_likes' => 563, 'total_gifts' => 89, 'gift_earnings' => 5600, 'category' => 'Gaming', 'started_at' => date('Y-m-d H:i:s'), 'status' => 'live'],
    ];
}

if (empty($scheduledStreams)) {
    $scheduledStreams = [
        ['id' => 5, 'title' => 'Weekend Vibes: Acoustic', 'thumbnail' => '/uploads/profiles/admin.jpg', 'user_id' => 2, 'creator_name' => 'Zara Ke', 'username' => 'zarake', 'creator_avatar' => '/uploads/profiles/admin.jpg', 'is_verified' => 1, 'started_at' => date('Y-m-d H:i:s', strtotime('+2 days')), ],
        ['id' => 6, 'title' => 'Creator Workshop: Editing', 'thumbnail' => '/uploads/profiles/admin.jpg', 'user_id' => 2, 'creator_name' => 'Zara Ke', 'username' => 'zarake', 'creator_avatar' => '/uploads/profiles/admin.jpg', 'is_verified' => 1, 'started_at' => date('Y-m-d H:i:s', strtotime('+1 day')), ],
    ];
}
    ...
    <div style="padding: 0 16px; margin-bottom: 24px;">
        ...
        <div class="scroll-row">
            ...
            <div class="scheduled-card">
                ...
                <div style="padding: 10px;">
                    <div style="display: flex; align-items: center; gap: 6px;">
                        <img src="<?= $stream['creator_avatar'] ?? '/uploads/profiles/admin.jpg' ?>" alt="" style="width: 24px; height: 24px; border-radius: 50%; object-fit: cover;">
